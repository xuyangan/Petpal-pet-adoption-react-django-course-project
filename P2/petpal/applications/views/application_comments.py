...
class MessageCreateAPIView(CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        if self.request.user == application.pet_seeker or self.request.user == application.pet_shelter:
            message = serializer.save(application=application, sender=self.request.user)
            ...
            raise serializers.ValidationError("You are not authorized to send a message for this application.")
